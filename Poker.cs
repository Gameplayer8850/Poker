...
namespace Poker
{
    ...
    class Stol : Talia
    {
        ...
        protected void Wyniki(Reka_zawodnika[] zawodnicy) //sortuje graczy według wartości ich kart oraz wyświetla tabele wyników
        {
            ...
            for(int i=0; i<Ilosc_graczy-1; i++) //sprawdza czy paru graczy nie ma takiej samej wartości kart oraz ustala który z nich ma "mocniejszą" rękę w zależności od układu
            {
